...
public class EntitiesControllerTest extends AbstractControllerTest {
	...
	public void setUp() throws IOException {
		...
		wireMockRule.stubFor(get(urlPathEqualTo("/entities")).willReturn(aResponse().withStatus(200).withBody("").withFixedDelay(200)));
		wireMockRule.stubFor(put(urlPathEqualTo("/entities")).willReturn(aResponse().withStatus(200).withBody("").withFixedDelay(200)));
